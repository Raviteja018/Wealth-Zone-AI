  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-8 mb-16"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-emerald-100 mb-8 text-lg max-w-2xl mx-auto">Our consultants are here to help you make the right technology decisions.</p>
            <Link
              to="/contact"

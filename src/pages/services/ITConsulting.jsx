...
import { TrendingUp, Rocket, Server, Shield, Sparkles, ArrowRight, CheckCircle2, Zap, Lightbulb } from 'lucide-react';
...
const ITConsulting = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Guide your organization through digital transformation with expert consulting.',
      icon: Rocket,
    ...
    },
    {
      ...
      description: 'Design and implement robust IT infrastructure solutions for your business.',
      icon: Server,
      gradient: 'from-sky-500 to-blue-600',
      link: '/services/it-consulting/it-infrastructure'
    },
    {
      ...
      link: '/services/it-consulting/security-compliance'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full mb-6">
            ...
            <span className="text-sm font-semibold text-blue-600">Strategic Consulting</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Expert guidance to help you navigate the complex world of information technology.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Need expert IT advice for your business?</h2>
            <p className="text-blue-100 mb-8 text-lg max-w-2xl mx-auto">Our consultants are here to help you make the right technology decisions.</p>
            <Link
              to="/contact"

      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-blue-200 rounded-full mb-6 shadow-sm">
            ...
            <span className="text-sm font-semibold text-blue-600">Community Safety</span>
          </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Protect Your Community?</h2>
            <p className="text-blue-100 mb-8 text-lg max-w-2xl mx-auto">Let us help you maintain a safe and positive online environment for your users.</p>
            <Link
              to="/contact"

...
const GoogleMapping = () => {
  const services = [
    {
      title: 'Custom Maps',
      description: 'Tailored Google Maps integration for your website or application.',
      icon: MapPin,
    ...
    },
    {
      ...
      description: 'Advanced geolocation and routing solutions for your business.',
      icon: Navigation,
      gradient: 'from-blue-500 to-cyan-500',
      iconBg: 'bg-blue-100',
      iconColor: 'text-blue-600'
    ...
    },
    {
      ...
      description: 'Interactive maps to visualize your location-based data.',
      icon: Layers,
      gradient: 'from-blue-500 to-cyan-500',
      iconBg: 'bg-blue-100',
      iconColor: 'text-blue-600'
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Transform your business with powerful location-based services and interactive mapping solutions.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Map Your Success?</h2>
            <p className="text-red-100 mb-8 text-lg max-w-2xl mx-auto">Let's build powerful location-based solutions that drive engagement and growth.</p>
            <Link
              to="/contact"

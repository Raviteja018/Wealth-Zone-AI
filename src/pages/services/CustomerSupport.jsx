...
import { Phone, MessageCircle, Clock, Heart, Sparkles, ArrowRight, CheckCircle2, Zap, Headset } from 'lucide-react';

const CustomerSupport = () => {
  const features = [
    {
      title: 'Multi-Channel Support',
      description: 'Support via email, chat, phone, and social media — all in one place.',
      icon: MessageCircle,
      gradient: 'from-green-500 to-emerald-500'
    },
    {
      title: '24/7 Availability',
      description: 'Round-the-clock support to keep your customers happy anytime.',
      icon: Clock,
      gradient: 'from-blue-500 to-cyan-500'
    },
    {
      title: 'AI-Powered Ticketing',
      description: 'Smart routing and automation to resolve issues faster.',
      icon: Phone,
      gradient: 'from-purple-500 to-pink-500'
    },
    {
      title: 'Personalized Service',
      description: 'Tailored support experiences that build loyalty and trust.',
      icon: Heart,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Deliver exceptional customer experiences with fast, reliable, and empathetic support.
          </p>
        </motion.div>
        ...
        <motion.div 
          className="bg-gradient-to-r from-blue-600 to-blue-600 rounded-2xl p-12 text-center relative overflow-hidden"
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Get Ready to Transform Your Support</h2>
            <p className="text-green-100 mb-8 text-lg max-w-2xl mx-auto">Let us handle your support so you can focus on growth and customer satisfaction.</p>
            <Link
              to="/contact"

...
import { Cloud, Upload, Lock, Settings, Sparkles, ArrowRight, CheckCircle2, Zap } from 'lucide-react';
...
const CloudServices = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      link: '/services/cloud-services/cloud-security'
    },
    {
      ...
      link: '/services/cloud-services/cloud-management'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-blue-200 rounded-full mb-6 shadow-sm">
            ...
            <span className="text-sm font-semibold text-blue-600">Cloud Solutions</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Scalable and secure cloud solutions to power your business.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 mb-8 text-lg max-w-2xl mx-auto">Transform your infrastructure with our secure, scalable cloud solutions.</p>
            <Link
              to="/contact"

      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-pink-100 rounded-full mb-6">
            ...
            <span className="text-sm font-semibold text-blue-600">Custom Development</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Custom software solutions designed to drive your business forward.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 mb-8 text-lg max-w-2xl mx-auto">Let's turn your vision into reality with cutting-edge technology.</p>
            <Link
              to="/contact"

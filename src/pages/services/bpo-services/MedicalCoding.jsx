    ...
    const services = [
        {
            ...
            link: '/services/bpo-services/medical-coding/icd-10-coding'
        },
        {
            ...
            link: '/services/bpo-services/medical-coding/cpt-coding'
        },
        {
            ...
            link: '/services/bpo-services/medical-coding/compliance-auditing'
        },
        {
            title: 'Revenue Cycle',
            ...
            link: '/services/bpo-services/medical-coding/revenue-cycle'
        }
    ];
                ...
                <div className="relative max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                            Medical <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Coding</span>
                        </h1>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-indigo-600">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready to Optimize Your Medical Coding?</h2>

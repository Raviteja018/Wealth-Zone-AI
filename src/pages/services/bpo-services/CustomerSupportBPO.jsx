...
import { Headphones, MessageSquare, Clock, Globe, ArrowRight, Sparkles, CheckCircle2, Zap, Users, Shield, Activity, BarChart } from 'lucide-react';

const CustomerSupportBPO = () => {
    const features = [
        {
            icon: MessageSquare,
        ...
        },
        {
            ...
            description: 'Support in multiple languages to cater to a global customer base.'
        },
        {
            icon: Users,
            title: 'Scalable Staffing',
            description: 'Flexible team sizes to handle peak seasons and business growth.'
        }
    ];
    ...
    const useCases = [
        {
            title: 'E-commerce',
            description: 'Handling order inquiries, returns, and product questions.'
        },
        {
            title: 'SaaS Companies',
            description: 'Providing technical assistance and onboarding support.'
        },
        {
            title: 'Healthcare',
            description: 'Managing appointment scheduling and patient inquiries.'
        },
        {
            title: 'Travel & Hospitality',
            description: 'Assisting with bookings, cancellations, and travel updates.'
        }
    ];
                ...
                <div className="relative max-w-7xl mx-auto">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-blue-200 rounded-full mb-6 shadow-sm">
                            ...
                            <span className="text-sm font-semibold text-blue-600">World-Class Support</span>
                        </div>

                        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                            Customer Support <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">BPO</span>
                        </h1>

                        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                            Delight your customers with professional, empathetic, and efficient support services.
                        </p>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            We become an extension of your brand, delivering consistent quality.
                        </p>
                    </motion.div>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Comprehensive support solutions for every need
                        </p>
                    </motion.div>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Tailored support strategies for diverse business sectors
                        </p>
                    </motion.div>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                            Partner with us to provide exceptional experiences for your customers.
                        </p>
                        <Link
                            to="/contact"
...
export default CustomerSupportBPO;

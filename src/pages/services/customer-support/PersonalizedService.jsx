...
import { UserCheck, Heart, Star, Smile, ArrowRight, Sparkles, CheckCircle2, Zap, UserPlus, Gift, MessageCircle, ThumbsUp } from 'lucide-react';
...
const PersonalizedService = () => {
    const features = [
        {
            ...
            description: 'Assign specific agents to high-value clients for consistent support.'
        },
        {
            icon: Heart,
            title: 'Empathy Training',
            description: 'Agents trained to understand and respond to customer emotions effectively.'
        },
        {
            icon: Star,
            title: 'VIP Support',
            description: 'Exclusive support tiers for your most important customers.'
        },
        {
            icon: Smile,
            title: 'Proactive Outreach',
            description: 'Checking in with customers to ensure satisfaction before issues arise.'
        }
    ];
    ...
    const useCases = [
        {
            title: 'Luxury Brands',
            description: 'Providing white-glove service to discerning clientele.'
        },
        {
            title: 'Financial Advisory',
            description: 'Building long-term trust with personalized financial guidance.'
        },
        {
            title: 'Subscription Services',
            description: 'Reducing churn by making every subscriber feel valued.'
        },
        {
            title: 'Hospitality',
            description: 'Creating memorable guest experiences through personalized attention.'
        }
    ];
        ...
        <div className="min-h-screen bg-white">
                ...
                <div className="relative max-w-7xl mx-auto">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-cyan-200 rounded-full mb-6 shadow-sm">
                            ...
                            <span className="text-sm font-semibold text-cyan-600">Human Connection</span>
                        </div>

                        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                            Personalized <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-600">Service</span>
                        </h1>

                        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                            Go beyond transactions. Build lasting relationships with every interaction.
                        </p>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl font-bold text-gray-900 mb-4">The Personal Touch</h2>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-4xl font-bold text-gray-900 mb-4">Building Relationships</h2>
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Creating loyal advocates through personalized care
                        </p>
                    </motion.div>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-cyan-100 mb-8 leading-relaxed">
                            Start treating your customers like the individuals they are.
                        </p>
                        <Link
                            to="/contact"

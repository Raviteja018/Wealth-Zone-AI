...
import { Smartphone, Code, Zap, Globe, CheckCircle2, ArrowRight, Sparkles, Layout, Monitor, Wifi, Shield } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Native iOS applications built with Swift and SwiftUI for the Apple ecosystem.'
    },
    {
      icon: Monitor,
      title: 'Android Development',
      description: 'Powerful Android apps built with Kotlin and Jetpack Compose for the widest reach.'
    },
    {
      icon: Globe,
      title: 'Cross-Platform',
      description: 'Cost-effective solutions using React Native and Flutter to deploy on both platforms.'
    },
    {
      icon: Layout,
      title: 'App UI/UX Design',
      description: 'Intuitive and engaging mobile interfaces designed for touch interactions.'
    }
  ];
  ...
  const useCases = [
    {
      ...
      description: 'Apps for food delivery, ride-sharing, and home services with real-time tracking.'
    },
    {
      title: 'FinTech Apps',
      description: 'Secure mobile banking, digital wallets, and investment platforms.'
    },
    {
      title: 'Health & Fitness',
      description: 'Workout tracking, telemedicine, and wellness apps with wearable integration.'
    },
    {
      title: 'Social Media',
      description: 'Community apps for connecting people, sharing content, and messaging.'
    }
  ];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-blue-200 rounded-full mb-6 shadow-sm">
              ...
              <span className="text-sm font-semibold text-blue-600">Mobile Solutions</span>
            </div>

            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              Mobile App <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-600">Development</span>
            </h1>

            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
              Transform your ideas into powerful mobile experiences. We build native and cross-platform apps that users love and businesses rely on.
            </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Mobile Expertise</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Delivering seamless mobile experiences across all devices and platforms
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">App Solutions</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Innovative mobile applications for various industries
            </p>
          </motion.div>

...
export default function ContactUs() {
  ...
  return (
    <section className="bg-blue-50 min-h-screen py-16 px-4 sm:px-6 lg:px-12">
      {/* Heading */}
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  2nd floor, A2 Square, Building, Jai Hind Gandhi Rd, Cyber
          ...
          <form className="flex flex-col gap-4">
            <div className="grid grid-cols-1 gap-4">
              <input
                ...
                className="px-4 py-3 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-300"
              />
              <input
                type="email"
            ...
            <textarea
              placeholder="Message *"
              rows="5"
              className="px-4 py-3 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-300 resize-none"
            ></textarea>

            <button
              type="submit"
              className="w-full mt-0 lg:mt-8 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg transition-all duration-300"
            >
              Send Message
            </button>
          </form>

...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-white/100 via-white/95 to-white/0 z-0"></div>
      ...
      {/* Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-12 sm:py-16 flex flex-col lg:flex-row items-center justify-between relative z-10">
        {/* Left Content */}
